...
class ClaudeClient:
    def __init__(self, api_key: str = CLAUDE_API_KEY, model: str = "claude-3-opus-20240229"):
        ...
        self.tools = [{
            ...
            "description": "Retrieves information from web search based on user queries",
            "input_schema": {
                "type": "object",
                "properties": {
                    "query": {
                        "type": "string",
                        "description": "The search query or topic to look up information about"
                    }
                },
                "required": ["query"]
            }
        ...
        while retry_count < max_retries:
            try:
                ...
                if retry_count < max_retries:
                    ...
                    return {
                        "error": "MCP server not responding after retries"
                    }
